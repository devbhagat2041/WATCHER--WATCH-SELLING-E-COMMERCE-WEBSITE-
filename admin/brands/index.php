...
<head>
  ...
  <title>AdminWATCHER | Brands</title>
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" enctype="multipart/form-data" id="brand" name="brand" method="POST" action="insert.php" onsubmit="return do_insert();">
              <div class="card-body">
          ...
          <table id="brand_tbl" name="brand_tbl">
            <thead>
              <tr>
                <th>ID</th>
                <th>Brand Name</th>
      ...
      <script>
        ...
        $("#brand").validate({
          ...
          messages: {
            ...
            brand_image: {
              required: "Please enter your brand image*",
            },
            category: {
          ...
          errorPlacement: function(error, element) {
            ...
            } else if (element.attr("id") == "brand_image") {
              $("#error_brandimg").html(error);
            ...
            $.ajax({
              ...
              success: function(response) {
                if (response == "success") {
                  ...
                  swal("New brand added successfully!", "", "success");
                  $("#brand")[0].reset();
        ...
        $(document).on('click', '.btnEdit', function() {
          ...
          window.location.href = "edit.php?id=" + brand_id;
            ...
            if (willDelete) {
              ...
              $.ajax({
                ...
                success: function(response) {
                  if (response == "success") {
                    $('#brand_tbl').DataTable().ajax.reload();
                    swal("Brand removed successfully!", "", "success");
                  } else {
        ...
        $(document).on('click', '.btnS', function(e) {
          ...
          var brand_id = $tds.find('span.btnId').toArray().map(span => $(span).attr('data-id'));

          var b_id = brand_id.toString();
          ...
          $.ajax({
            ...
            success: function(response) {
              if (response == "disabled") {
                $('#brand_tbl').DataTable().ajax.reload();
                swal("Brand disabled successfully!", "", "success");
              } else if (response == "activated") {
                $('#brand_tbl').DataTable().ajax.reload();
                swal("Brand activated successfully!", "", "success");
              } else {
                swal("Something went wrong, Try again!", "", "error");
              }
            }
